 ...
 */
internal object NooliteBinParser {
    private const val NEXT_OFFSET = 24
    private const val NEXT_GROUP_OFFSET = 32
    private const val NEXT_CHANNEL_OFFSET = 25

    private const val MAX_GROUPS = 16
    private const val MAX_CHANNELS = 32
    private const val CHANNELS_IN_GROUP = 8

    private const val START_FILE_OFFSET = 6 // identifies ethernet-gateway model number (PR1132)
    private const val START_GROUP_OFFSET = START_FILE_OFFSET + NEXT_OFFSET
    private const val START_CHANNEL_OFFSET = START_FILE_OFFSET + NEXT_GROUP_OFFSET * MAX_GROUPS
    private const val START_CHANNEL_TYPE_OFFSET = START_CHANNEL_OFFSET + NEXT_OFFSET
